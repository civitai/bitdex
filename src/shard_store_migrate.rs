...
//! compaction.
//!
//! For BitmapFs (.fpack, .sort, .roar), the migration reads the existing files
//! and writes them as ShardStore snapshots. The existing formats are read-only
//! during migration — all new writes go through ShardStore.
